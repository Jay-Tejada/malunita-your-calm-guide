...
export const SimpleOrb = ({ 
  ...
  return (
    <motion.button
      onClick={onTap}
      className="orb-button relative w-[100px] h-[100px] rounded-full focus:outline-none cursor-pointer border-none"
      animate={{ 
        scale: isRecording ? [1.1, 1.15, 1.1] : [1, 1.02, 1],
      }}
      whileHover={{ scale: 1.05 }}
      whileTap={{ scale: 0.98 }}
      transition={{ 
        scale: { duration: isRecording ? 1 : 4, repeat: Infinity, ease: "easeInOut" }
      }}
      style={{
        background: isRecording 
          ...
          : 'radial-gradient(circle at 35% 35%, #fef3c7 0%, #fde68a 30%, #fbbf24 60%, #f59e0b 100%)',
        boxShadow: isRecording
          ? '0 8px 32px rgba(239, 68, 68, 0.3), inset 0 2px 8px rgba(255, 255, 255, 0.5)'
          : isProcessing
          ? '0 8px 32px rgba(59, 130, 246, 0.3), inset 0 2px 8px rgba(255, 255, 255, 0.5)'
          : '0 8px 32px rgba(251, 191, 36, 0.3), inset 0 2px 8px rgba(255, 255, 255, 0.5)',
      }}
    >
