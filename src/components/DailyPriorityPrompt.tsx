...
export const DailyPriorityPrompt = forwardRef<DailyPriorityPromptRef, DailyPriorityPromptProps>(
  ({ onTaskCreated }, ref) => {
    const {
      showPrompt,
    ...
    const handleDialogOpenChange = (open: boolean) => {
      ...
      // If user manually closes the dialog (X or clicking outside), treat as skipping for today
      if (!open && showPrompt) {
        markPromptSkipped();
      }
    };
        ...
        const createdTasks = await createTasks([
          {
            ...
            context:
              enriched.context?.taskContext?.[0]?.contextSummary ||
              "Daily primary focus task",
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Button onClick={handleSubmit} disabled={!taskInput.trim() || isSubmitting}>
